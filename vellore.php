    ...
    <div class="breadcumb-wrapper " data-bg-src="assets/scan-world/breadcrumb.png">
        <div class="container">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title text-white"> Scans World on Vellore</h1>
            ...
            <div class="row flex-row-reverse">
                ...
                <div class="col-xl-6 text-center text-xl-start">
                    ...
                    <h1><span class="sub-title"><img src="assets/scan-world/icon.webp" alt="shape">Diagnostic Centre in Vellore – Advanced Scans & Imaging Services</span></h1>
                        ...
                        <h2 class="box-title"> Accurate Diagnostic Reports from a Diagnostic Centre in Vellore—Scansworld</h2>
                ...
                <div class="col-xl-6 mb-40 mb-xl-0">
                    <div class="img-box7" style="margin: 0px 50px 0px 0px;">
                        <div class="img1">
                            <img data-mask-src="assets/img/normal/about_4_mask.png" src="assets/scan-world/centers/vellore.webp" alt="About">
                        </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="location-card">
                        <h3 class="box-title">Vellore Branch</h3>
                        <p class="footer-info">
                            <i class="far fa-location-dot"></i>
                            No. 54, Dharmaraja Koil Street, Thottapalayam, Vellore-632 004, Tamilnadu
                        </p>
                        <p class="footer-info">
                            <i class="far fa-envelope"></i>
                            <a href="mailto:scansworldatvellore@gmail.com" class="info-box_link">scansworldatvellore@gmail.com</a>
                        </p>
                        <p class="footer-info">
                            <i class="far fa-phone"></i>
                            <a href="tel:+04435059999" class="info-box_link">0416 - 3509999</a>
                        </p>
                        <p class="footer-info">
                ...
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3736.8119511699774!2d79.1309709748922!3d12.926038187385203!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bad39004ca782e5%3A0x4af0a1c46919053d!2sScans%20World%20Vellore!5e1!3m2!1sen!2sin!4v1778564603568!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
        </div>
    </div>
