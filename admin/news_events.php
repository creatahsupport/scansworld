...
$sql = "SELECT  * FROM news_events WHERE del_i=0 order by id desc";
            ...
            <div class="row align-items-center">
              ...
              <div class="col-md-12">
                <div class="page-header-title">
                  <h2 class="mb-0">News & Events List</h2>
                </div>
              </div>
...
<div class="row">
    <div class="col-sm-12">
        <div class="card border-0 table-card user-profile-list">
            <div class="card-body">
            <a value="Add New" href= "add_news_events.php" class="btn btn-primary btn-lg">Add New</a></div>
                        ...
                        <tbody>
                          ...
                          ?>
                              <tr>
                                  ...
                                  <td>
                                      <div class="d-flex">
                                          <a href="edit_news_events.php?id=<?php echo $row['id']; ?>" class="btn btn-primary btn-sm me-2">Edit</a>
                                          <form action="delete_news_events.php" onsubmit="return validate(this);" method="post">
