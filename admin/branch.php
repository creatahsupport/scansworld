...
if ($user_role == "admin") {
    ...
    if ($result1 && $result1->num_rows === 1) {
        ...
        $sql = "SELECT * FROM branch WHERE id = '$branch_id' AND del_i = 0 ORDER BY id DESC";
        // print_r($sql);die;
        $result = $con->query($sql);
    } else {
...
<div class="row">
    <div class="col-sm-12">
        <div class="card border-0 table-card user-profile-list">
            <div class="card-body">
            <a value="Add New" href= "add_branch.php" class="btn btn-primary btn-lg">Add New</a>
          </div>
                        ...
                        <tbody>
                          ...
                          ?>
                              <tr>
                                  ...
                                  <td>
                                      <div class="d-flex">
                                          <a href="edit_branch.php?id=<?php echo $row['id']; ?>" class="btn btn-primary btn-sm me-2">Edit</a>
                                          <form action="delete_branch.php" onsubmit="return validate(this);" method="post">
