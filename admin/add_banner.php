          ...
          <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control" name="image_type" id="mediaType" required aria-label="Media Type" onchange="toggleFields()">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="image_alt" required placeholder="Image Alt Tag">
                </div>
                </div>
                <div class="col-sm-4">
                <div class="mb-3">
                    <label class="form-label">Image Title Tag</label>
                    <input type="text" class="form-control" name="image_title" required placeholder="Image Title Tag">
                </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="mb-3">
                    ...
                    <input type="file" class="form-control" name="image"  required id="imageUpload" aria-label="Upload Image" accept="image/png, image/webp">
                </div>
                </div>
            </div>
