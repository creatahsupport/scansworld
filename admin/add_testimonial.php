...
<!doctype html>
<html lang="en">
<title>Testimonial | Scans World</title>
<meta charset="utf-8" />
...
<?php include("include/sidebar.php") ?>
  ...
  <div class="col-sm-12">
    <div class="card">
      <div class="card-body">
        <div class="container">
          <form method="POST" action="insert_testimonial.php" enctype="multipart/form-data" onsubmit="return validateForm()">
            <div class="row">
              <div class="col-sm-4">
                <div class="mb-3">
                <label class="form-label">Name</label>
                <input type="text" class="form-control" name="title" required placeholder="Name" aria-label="Title" aria-describedby="basic-addon1">
                </div>
              </div>
              <div class="col-sm-4">
                <div class="mb-3">
                <label class="form-label">Review</label>
                <input type="text" class="form-control" name="review" required placeholder="Review" aria-label="Review" aria-describedby="basic-addon1">
                </div>
              </div>
              <div class="col-sm-4">
                <div class="mb-3">
                <label class="form-label">Content</label>
                <textarea class="form-control" name="content" required placeholder="Content"></textarea>
              </div>
            </div>
            </div>
