      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="card border-0 table-card user-profile-list">
            <div class="card-body">
              <a value="Add New" href="add_testimonial.php" class="btn btn-primary btn-lg">Add New</a>
            </div>
                  ...
                  if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="text-3"><?= truncateWords($row['content'], 5) ?>
                        </td>
                        <td>
                          <div class="d-flex">
                            <a href="edit_testimonial.php?id=<?php echo $row['id']; ?>"
