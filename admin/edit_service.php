...
<!doctype html>
<html lang="en">
<title>Service | Scans World</title>
<meta charset="utf-8" />
...
<?php include("include/sidebar.php") ?>
  ...
  <div class="col-sm-12">
    <div class="card">
      <div class="card-body">
        <div class="container">
          <form method="POST" action="update_service.php" enctype="multipart/form-data" onsubmit="return validateForm()">
            <div class="row">
              <div class="col-sm-4">
                <div class="mb-3">
                  <label class="form-label">Service Name</label>
                  <input type="hidden"  name="department_id" value="<?php echo $service['id']; ?>">
                  <input type="text" name="department" class="form-control" value="<?php echo $service['service_name']; ?>" placeholder="Enter Department Name" oninput="validatename(this)" required>
                </div>
              </div>
