...
<?php include("include/sidebar.php") ?>
            ...
            <div class="row align-items-center">
              ...
              <div class="col-md-12">
                <div class="page-header-title">
                  <h2 class="mb-0">Add News & Events</h2>
                </div>
              </div>
            </div>
          </div>
  ...
  <div class="col-sm-12">
    <div class="card">
      <div class="card-body">
        <div class="container">
          <form method="POST" action="insert_news_events.php" enctype="multipart/form-data">
            <div class="row">
              <div class="col-sm-4">
                <div class="mb-3">
              ...
              <div class="col-sm-4">
                ...
                <input type="file" class="form-control" name="image" required accept="image/webp">
            ...
            <div class="row">
              ...
              <div class="col-sm-4">
                ...
                <input type="text"  class="form-control" name="meta_title" required placeholder="image Title"  title="Only alphanumerics and dashes are allowed" aria-label="Username" aria-describedby="basic-addon1"> 
                    </div>
                </div>
                </div>
                <!-- <div class="col-sm-12">
                ...
                <div class="mb-3">
                  ...
                  <textarea class="form-control" id="editor-content"  name="content" aria-label="With textarea"></textarea>
               </div>
                </div>
            </div>
