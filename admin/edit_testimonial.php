...
<?php include("include/sidebar.php") ?>
  ...
  <div class="col-sm-12">
    <div class="card">
      <div class="card-body">
        <div class="container">
          <form method="POST" action="update_testimonial.php" enctype="multipart/form-data" onsubmit="return validateForm()">
            <div class="row">
              <div class="col-sm-4">
                <div class="mb-3">
              ...
              <div class="col-sm-4">
                ...
                <textarea class="form-control" name="content" required placeholder="Content"><?= $content ?></textarea>
              </div>
            </div>
            </div>
