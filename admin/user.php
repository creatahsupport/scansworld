...
$sql = "SELECT  * FROM admin WHERE del_i=0 order by id desc";
...
<div class="row">
    <div class="col-sm-12">
        <div class="card border-0 table-card user-profile-list">
            <div class="card-body">
            <a value="Add New" href= "add_user.php" class="btn btn-primary btn-lg">Add New</a></div>
                        ...
                        <tbody>
                          ...
                          ?>
                              <tr>
                                  ...
                                  <td>
                                      <div class="d-flex">
                                          <a href="edit_user.php?id=<?php echo $row['id']; ?>" class="btn btn-primary btn-sm me-2">Edit</a>
                                          <form action="user_delete.php" onsubmit="return validate(this);" method="post">
