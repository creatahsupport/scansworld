      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="card border-0 table-card user-profile-list">
            <div class="card-body">
              <a value="Add New" href="add_gallery.php" class="btn btn-primary btn-lg">Add New</a>
            </div>
                  ...
                  if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                      ...
                      <tr>
                          ...
                          <div class="text-3">
                            <?php if (!empty($row['image'])): ?>
                              <a href="../uploads/gallery/<?= htmlspecialchars($row['image']) ?>" target="_blank">
                                <img src="../uploads/gallery/<?= htmlspecialchars($row['image']) ?>" alt="Image Preview"
                        ...
                        <td>
                          <div class="d-flex">
                            <a href="edit_gallery.php?id=<?php echo $row['id']; ?>"
