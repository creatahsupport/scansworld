<footer class="footer-wrapper footer-layout3">
    <div class="shape-mockup" data-top="0" data-right="0"><img
            src="<?php echo $url_config; ?>/assets/img/shape/pattern_shape_5.png" alt="shape"></div>
    <div class="shape-mockup" data-bottom="0" data-left="0"><img
            src="<?php echo $url_config; ?>/assets/img/shape/pattern_shape_6.png" alt="shape"></div>
            ...
            <div class="row justify-content-between">
                    ...
                    <div class="widget footer-widget">
                        <div class="th-widget-about">
                            <div class="about-logo">
                                <a href="<?php echo $url_config; ?>/"><img
                                        src="<?php echo $url_config; ?>/assets/scan-world/footer-logo.webp"
                                        alt="Scans World"></a>
                            </div>
                            <p class="about-text">Pioneering in the world of Medical Imaging with cutting-edge
                                technology. We seek to reveal the internal structures to diagnose and treat disease.
                                Your neighborhood diagnostic center caters to all your needs. Because we care!</p>
                ...
                <div class="col-md-6 col-xl-auto">
                    <div class="widget widget_nav_menu footer-widget">
                        ...
                        <div class="menu-all-pages-container">
                            <ul class="menu">
                                <li><a href="<?php echo $url_config; ?>/about-us">About Us</a></li>
                                <li><a href="<?php echo $url_config; ?>/our-doctors">Our Experts</a></li>
                                <li><a href="<?php echo $url_config; ?>/blog">Blogs</a></li>
                                <li><a href="<?php echo $url_config; ?>/news-and-events">News & Events</a></li>
                                <li><a href="<?php echo $url_config; ?>/gallery">Gallery</a></li>
                                <li><a href="<?php echo $url_config; ?>/testimonials">Testimonials</a></li>
                ...
                <div class="col-md-6 col-xl-auto">
                    <div class="widget widget_nav_menu footer-widget">
                        ...
                        <div class="menu-all-pages-container">
                            <ul class="menu">
                                <li><a href="<?php echo $url_config; ?>/mri-scan">MRI Scan</a></li>
                                <li><a href="<?php echo $url_config; ?>/pet-ct">160 Slice Digital PET CT</a></li>
                                <li><a href="<?php echo $url_config; ?>/160-slice-cardiac-ct">160 Slice Cardiac CT</a>
                                </li>
                                <li><a href="<?php echo $url_config; ?>/gamma-camera">Nuclear Scans / Gamma camera</a>
                                </li>
                                <li><a href="<?php echo $url_config; ?>/multislice-ct-scan">Multislice CT Scan</a></li>
                                <li><a href="<?php echo $url_config; ?>/digital-mammography">Digital Mammography</a>
                                </li>
...
if ($last_segment == "book-appointment") { ?>
    <a href="https://wa.me/919944618362" target="_blank" class="contact-button whatsapp-button">
        <img src="<?php echo $url_config ?>/assets/scan-world/whatsapp-icon.webp" width="70px" alt="whatsapp-icon"
            title="Whatsapp-icon">
    </a>
    ...
    <?php } else { ?>
        ...
        <div class="appoint">
            ...
            <a class="bkapt" href="<?php echo $url_config; ?>/book-appointment">
