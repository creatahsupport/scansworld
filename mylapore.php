    ...
    <div class="breadcumb-wrapper " data-bg-src="assets/scan-world/breadcrumb.png">
        <div class="container">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title text-white"> Scans World On Mylapore</h1>
            ...
            <div class="row flex-row-reverse">
                ...
                <div class="col-xl-6 text-center text-xl-start">
                    ...
                    <span class="sub-title"><img src="assets/scan-world/icon.webp" alt="shape">About our Center</span>
                        <!-- <h2 class="sec-title">The Best Diagnostic Centre in Chennai</h2> -->
                         <h2 class="sec-title">Scan Point - Mylapore</h2>
                ...
                <div class="col-xl-6 mb-40 mb-xl-0">
                    <div class="img-box7" style="margin: 0px 50px 0px 0px;">
                        <div class="img1">
                            <img src="assets/scan-world/centers/mylapore.png" alt="About">
                        </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="location-card">
                        <h3 class="box-title">Mylapore Branch</h3>
                        <p class="footer-info">
                        ...
                        <p class="footer-info">
                            ...
                            <a href="tel:+4443331000" class="info-box_link"> 444 - 3331 000</a>
                        </p>
                        <p class="footer-info">
                ...
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3735.109725387695!2d80.26183759999999!3d13.0392713!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a5267fb9c30f779%3A0x2c4710fc5c79a945!2sScan%20Point%20-%20Mylapore!5e1!3m2!1sen!2sin!4v1745840480987!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
        </div>
    </div>
