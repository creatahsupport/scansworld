          ...
          <div class="page-single single-right mb-30">
            ...
            <div class="page-content">
              ...
              <div class="checklist mb-25">
                <ul>
                  <li><i class="fas fa-check-circle"></i> Higher Accuracy & Early Detection: Catch abnormalities at
                    their earliest stages, giving you the best chance for successful treatment.</li>
                  <li><i class="fas fa-check-circle"></i> Quick & Comfortable: Our state-of-the-art equipment ensures a
                    faster, more comfortable experience than traditional mammograms.</li>
                  <li><i class="fas fa-check-circle"></i> Low Radiation: Our digital mammograms use a lower dose of
                    radiation, making them a safe option for all women.</li>
                </ul>
              </div>
              <h3 class="h5 mt-1">For Women at Average Risk:</h3>
              <div class="checklist mb-25">
                <ul>
                  <li><i class="fas fa-check-circle"></i> Starting at age 40, you can opt for your first mammogram.</li>
                  <li><i class="fas fa-check-circle"></i> Regular mammograms are recommended starting at age 45 or 50.
                  </li>
                  <li><i class="fas fa-check-circle"></i> Detecting abnormalities early can save lives — book your
                    screening today!</li>
                </ul>
              </div>
              <h3 class="h5 mt-1">For Women at High Risk:</h3>
              <div class="checklist mb-25">
                <ul>
                  <li><i class="fas fa-check-circle"></i> If you have a family history of breast cancer or have
              ...
              <div class="accordion" id="faqAccordion">
                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingTwo">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      2. What can a Digital Mammogram detect?
                    </button>
                  </div>
                  <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                    data-bs-parent="#faqAccordion">
                    <div class="accordion-body">
                      <p class="faq-text">It can detect lumps, cysts, calcifications, dense breast tissue and early-stage
                        tumors often before any physical symptoms appear increasing the chances for successful
                        treatment.</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingThree">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      3. Which women should get a Digital Mammography done?
                    </button>
                  </div>
                  <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                    data-bs-parent="#faqAccordion">
                    <div class="accordion-body">
                      <p class="faq-text">All women 40 years and older should be screened. Women with a family history
                        of breast cancer or previous breast lesions should be screened before the age of 40 years.</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingFour">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      4. How is Digital Mammography performed at Scans World?
                    </button>
                  </div>
                  <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
                    data-bs-parent="#faqAccordion">
                    <div class="accordion-body">
                      <p class="faq-text">A trained female technician gently places the breast on the imaging plate,
                        applies mild compression for a few seconds and gets clear images. It all takes about 15 to 20
                ...
                <div class="accordion-card">
                  ...
                  <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive"
                    data-bs-parent="#faqAccordion">
                    <div class="accordion-body">
                      <p class="faq-text">Women at average risk should get a mammogram every year starting at age 45–50.
                        High-risk women may need to begin annual screening earlier based on their doctor's advice.</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingSix">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      6. How much radiation is used in Digital Mammography?
                    </button>
                  </div>
                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingSeven">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      7. How should I prepare for a Digital Mammography scan?
                    </button>
                  </div>
                  <div id="collapseSeven" class="accordion-collapse collapse" aria-labelledby="headingSeven"
                    data-bs-parent="#faqAccordion">
                    <div class="accordion-body">
                      <p class="faq-text">Avoid deodorant, talcum powder or lotion on your underarms and chest on the day
                        of the scan. Wear a two-piece outfit for convenience. No other special preparation is
                        needed.</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingEight">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      8. How long does it take to get the report at Scans World?
                    </button>
                  </div>
                  <div id="collapseEight" class="accordion-collapse collapse" aria-labelledby="headingEight"
                    data-bs-parent="#faqAccordion">
                    <div class="accordion-body">
                      <p class="faq-text">Reports are typically ready the same day or within 24 hours. Scans World
                        provides timely and accurate reporting by experienced radiologists.</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingNine">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      9. Which is the best center for Digital Mammography in Chennai?
                    </button>
                  </div>
                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingTen">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      10. What happens if an abnormality is found in my mammogram?
                    </button>
                  </div>
