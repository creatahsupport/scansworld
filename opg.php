            ...
            <div class="page-content">
             ...
             <p>This essential diagnostic tool helps in the early detection of dental and jaw-related issues such as tooth decay, impacted teeth, jawbone abnormalities, dental infections, and more.</p>
              ...
              <div class="checklist mb-25">
                <ul>
                  <li><i class="fas fa-check-circle"></i> Comprehensive imaging of teeth, jaws, and surrounding structures</li>
                  <li><i class="fas fa-check-circle"></i> Quick and non-invasive procedure with minimal radiation exposure</li>
                  <li><i class="fas fa-check-circle"></i> Ideal for routine check-ups, pre-surgical evaluations, and orthodontic planning</li>
                  <li><i class="fas fa-check-circle"></i> Accurate diagnostics to guide dental treatments and procedures.</li>
                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingTwo">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      2. What does OPG stand for in dentistry?
                    </button>
                  </div>
                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingThree">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      3. What conditions can an OPG Scan detect?
                    </button>
                  </div>
                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingFour">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      4. Who needs an OPG Scan?
                    </button>
                  </div>
                  <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
                    data-bs-parent="#faqAccordion">
                    <div class="accordion-body">
                      <p class="faq-text">Patients undergoing orthodontic treatment (braces). Patients needing dental
                        implants. Patients needing their wisdom teeth checked. Patients needing pre-surgical assessments.
                        Patients having routine dental check-ups. Patients with jaw pain or you suspect you have
                        problems with your jawbone.</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingFive">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      5. How is an OPG Scan performed at Scans World?
                    </button>
                  </div>
                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingSix">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      6. How should I prepare for an OPG Scan?
                    </button>
                  </div>
                  <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingSix"
                    data-bs-parent="#faqAccordion">
                    <div class="accordion-body">
                      <p class="faq-text">Remove any metal items such as earrings, necklaces, hair pins and glasses
                        prior to the scan as they can interfere with the image quality. No fasting or special
                        preparation is required. Inform the technician if you are pregnant.</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingSeven">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      7. How much radiation is used in an OPG Scan?
                    </button>
                  </div>
                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingEight">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      8. What is the difference between an OPG Scan and a regular dental X-ray?
                    </button>
                  </div>
                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingNine">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      9. How long does it take to get the OPG Scan report at Scans World?
                    </button>
                  </div>
                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingTen">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      10. Which is the best center for OPG Scan in Chennai?
                    </button>
                  </div>
