...
<head>
    ...
    <link rel="apple-touch-icon" sizes="57x57" href="<?php echo $url_config; ?>/assets/img/favicons/favicon-57x57.png">
    <link rel="apple-touch-icon" sizes="60x60" href="<?php echo $url_config; ?>/assets/img/favicons/favicon-60x60.png">
    <link rel="apple-touch-icon" sizes="72x72" href="<?php echo $url_config; ?>/assets/img/favicons/favicon-72x72.png">
    <link rel="apple-touch-icon" sizes="76x76" href="<?php echo $url_config; ?>/assets/img/favicons/favicon-76x76.png">
    <link rel="apple-touch-icon" sizes="114x114"
        href="<?php echo $url_config; ?>/assets/img/favicons/favicon-114x114.png">
    <link rel="apple-touch-icon" sizes="120x120"
        href="<?php echo $url_config; ?>/assets/img/favicons/favicon-120x120.png">
    <link rel="apple-touch-icon" sizes="144x144"
        href="<?php echo $url_config; ?>/assets/img/favicons/favicon-144x144.png">
    <link rel="apple-touch-icon" sizes="152x152"
        href="<?php echo $url_config; ?>/assets/img/favicons/favicon-152x152.png">
    <link rel="apple-touch-icon" sizes="180x180"
        href="<?php echo $url_config; ?>/assets/img/favicons/favicon-180x180.png">
    <link rel="icon" type="image/png" sizes="192x192"
        href="<?php echo $url_config; ?>/assets/img/favicons/android-icon-192x192.png">
    <link rel="icon" type="image/png" sizes="32x32"
        href="<?php echo $url_config; ?>/assets/img/favicons/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="96x96"
        href="<?php echo $url_config; ?>/assets/img/favicons/favicon-96x96.png">
    <link rel="icon" type="image/png" sizes="16x16"
        href="<?php echo $url_config; ?>/assets/img/favicons/favicon-16x16.png">
                ...
                <div class="col-xxl-4 col-lg-5">
                    <aside class="sidebar-area">
                        <div class="widget widget_search  ">
                            <form class="search-form" action="<?php echo $url_config; ?>/blog_search.php" method="GET"
                                onsubmit="return validateSearch()">
                                <input type="text" id="search-input" name="q" onkeyup="fetchSearchSuggestions()"
                                ...
                                <?php if (!empty($latest_blog)) { // Check if posts exist ?>
                                    <?php foreach ($latest_blog as $blg) { ?>
                                        <div class="recent-post">
                                            <div class="media-img">
                                                <a
                                                    href="<?php echo $url_config; ?>/blog-details/<?php echo urlencode($blg['slug']); ?>">
                                                    <img src="<?php echo $url_config; ?>/uploads/blog/<?php echo htmlspecialchars($blg['image']); ?>"
                                                        alt="<?php echo htmlspecialchars($blg['title']); ?>"
                                                        title="<?php echo htmlspecialchars($blg['title']); ?>" width="90px"
                                                        height="80px">
                                                </a>
                                            </div>
                                            <div class="media-body">
                                                <h4 class="post-title"><a class="text-inherit"
                                                        href="<?php echo $url_config; ?>/blog-details/<?php echo urlencode($blg['slug']); ?>"><?php echo (strlen($blg['title']) > 37) ? substr($blg['title'], 0, 37) . '...' : $blg['title']; ?></a>
                                                </h4>
                                                <div class="recent-post-meta">
                                                    <a
                                                        href="<?php echo $url_config; ?>/blog-details/<?php echo urlencode($blg['slug']); ?>"><i
                                                            class="fal fa-calendar"></i>
                                                        <?php echo date("d-M-Y", strtotime($blg['created_date'])); ?></a>
                                                </div>
                                            </div>
                                        </div>
                                    <?php } ?>
