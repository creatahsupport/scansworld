                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingOne">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      1. What is a 160 Slice Cardiac CT scan?
                    </button>
                  </div>
                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingTwo">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      2. What is the difference between a cardiac CT scan and a coronary angiogram?
                    </button>
                  </div>
                  <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                    data-bs-parent="#faqAccordion">
                    <div class="accordion-body">
                      <p class="faq-text">A traditional coronary angiogram is invasive (requires catheter insertion).
                        Scans World's 160-slice cardiac CT gives similar detailed images of the coronary arteries
                        non-invasively no needles, no hospital admission.</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingThree">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      3. What conditions can be detected with a 160 Slice Cardiac CT at Scans World?
                    </button>
                  </div>
                  <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                    data-bs-parent="#faqAccordion">
                    <div class="accordion-body">
                      <p class="faq-text">It helps detect coronary artery disease, arterial blockages, calcium deposits
                        in arteries, congenital heart defects and other heart-related conditions at an early stage.</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingFour">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      4. Which scan centre in Chennai offers 160 Slice Cardiac CT scanning?
                    </button>
                  </div>
                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingFive">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      5. Which doctors recommend a 160 Slice Cardiac CT scan?
                    </button>
                  </div>
                  <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive"
                    data-bs-parent="#faqAccordion">
                    <div class="accordion-body">
                      <p class="faq-text">Cardiologists, general physicians, and cardiac surgeons recommend this scan
                        for patients with chest pain, high blood pressure, diabetes or a family history of heart
                        disease.</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingSix">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      6. How long does a 160-slice cardiac CT scan take at Scans World?
                    </button>
                  </div>
                  <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingSix"
                    data-bs-parent="#faqAccordion">
                    <div class="accordion-body">
                      <p class="faq-text">Thanks to advanced 160-slice technology, the heart scan is completed quickly
                        with minimal waiting time typically within 15 to 30 minutes including preparation.</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingSeven">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      7. How is a 160 Slice CT better than a regular CT scan for the heart?
                    </button>
                  </div>
                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingEight">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      8. How do I prepare for a Cardiac CT scan at Scans World Chennai?
                    </button>
                  </div>
                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingNine">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      9. How do I book a 160 Slice Cardiac CT appointment at Scans World?
                    </button>
                  </div>
                  <div id="collapseNine" class="accordion-collapse collapse" aria-labelledby="headingNine"
                    ...
                    <div class="accordion-body">
                      <p class="faq-text">You can book online through their website, WhatsApp at +91 96269 59999, or
                        call directly. Walk-ins are also welcome at all three Chennai branches.</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingTen">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      10. How safe is the 160 Slice Cardiac CT scan?
                    </button>
                  </div>
                  <div id="collapseTen" class="accordion-collapse collapse" aria-labelledby="headingTen"
                    data-bs-parent="#faqAccordion">
                    <div class="accordion-body">
                      <p class="faq-text">It is a safe, non-invasive procedure using low-dose radiation technology. It
                        requires no surgery, no anesthesia, and no recovery time, making it a preferred choice for early
                        heart disease screening.</p>
                    </div>
                  </div>
                </div>
              </div>
