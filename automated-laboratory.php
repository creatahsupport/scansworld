                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingOne">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      1. What is an Automated Laboratory?
                    </button>
                  </div>
                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingTwo">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      2. What types of tests are available at Scans World's Automated Laboratory?
                    </button>
                  </div>
                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingThree">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      3. What makes Scans World's Automated Lab different from a regular diagnostic lab?
                    </button>
                  </div>
                  <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                    data-bs-parent="#faqAccordion">
                    <div class="accordion-body">
                      <p class="faq-text">Scans World, unlike conventional labs, uses fully automated analyzers with
                        networked data management system to ensure faster processing, consistent accuracy, continuous
                        quality assurance and reliable results every time.</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingFour">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      4. What blood tests can be done at Scans World's Automated Laboratory in Chennai?
                    </button>
                  </div>
                  <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
                    data-bs-parent="#faqAccordion">
                    <div class="accordion-body">
                      <p class="faq-text">An extensive selection of blood tests are available including CBC (Complete
                        Blood Count), blood sugar, lipid profile, liver function, kidney function, thyroid profile,
                        HbA1c, hormonal tests and several more.</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingFive">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      5. Which patients benefit most from Automated Laboratory testing at Scans World?
                    </button>
                  </div>
                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingSix">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      6. Which doctors refer patients to Scans World's Automated Laboratory?
                    </button>
                  </div>
                  <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingSix"
                    data-bs-parent="#faqAccordion">
                    <div class="accordion-body">
                      <p class="faq-text">General physicians, diabetologists, cardiologists, nephrologists,
                        endocrinologists and specialists across all fields refer patients to Scans World for trusted and
                        timely laboratory results to guide treatment planning.</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingSeven">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      7. How accurate are the lab test results at Scans World Chennai?
                    </button>
                  </div>
                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingEight">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      8. How quickly are lab test reports available at Scans World?
                    </button>
                  </div>
                  <div id="collapseEight" class="accordion-collapse collapse" aria-labelledby="headingEight"
                    data-bs-parent="#faqAccordion">
                    <div class="accordion-body">
                      <p class="faq-text">Thanks to automated processing and a fully networked data system, most routine
                        lab reports are available quickly with minimal waiting time ensuring patients and doctors
                        receive results without unnecessary delays.</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingNine">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      9. How should I prepare for a blood test at Scans World's Automated Laboratory?
                    </button>
                  </div>
                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingTen">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      10. How do I book a lab test appointment at Scans World Chennai?
                    </button>
                  </div>
