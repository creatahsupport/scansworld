                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingTwo">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      2. What is SPECT CT and how is it different from a regular Gamma Camera scan?
                    </button>
                  </div>
                  <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                    data-bs-parent="#faqAccordion">
                    <div class="accordion-body">
                      <p class="faq-text">SPECT CT combines Single Photon Emission Computed Tomography (SPECT) with CT
                        imaging in one system providing both functional and anatomical images simultaneously. This
                        results in much better, high resolution pictures, with a higher diagnostic accuracy than a
                        standard Gamma Camera scan alone.</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingThree">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      3. What conditions can be detected using a Gamma Camera / SPECT CT scan?
                    </button>
                  </div>
                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingFour">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      4. What types of nuclear scans are available at Scans World Chennai?
                    </button>
                  </div>
                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingFive">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      5. What makes Scans World's Gamma Camera / SPECT CT superior to other nuclear imaging centres in Chennai?
                    </button>
                  </div>
                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingSix">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      6. Which doctors refer patients for Gamma Camera / Nuclear scans?
                    </button>
                  </div>
                  <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingSix"
                    data-bs-parent="#faqAccordion">
                    <div class="accordion-body">
                      <p class="faq-text">Oncologists, nuclear medicine physicians, cardiologists, endocrinologists,
                        nephrologists and orthopaedic surgeons refer patients for nuclear scans when standard imaging is
                        insufficient or when functional assessment of organs is required.</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingSeven">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      7. How is a Gamma Camera scan performed at Scans World?
                    </button>
                  </div>
                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingEight">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      8. How safe is a Nuclear Scan / Gamma Camera scan?
                    </button>
                  </div>
                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingNine">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      9. How long does a Gamma Camera / SPECT CT scan take at Scans World?
                    </button>
                  </div>
                  <div id="collapseNine" class="accordion-collapse collapse" aria-labelledby="headingNine"
                    data-bs-parent="#faqAccordion">
                    <div class="accordion-body">
                      <p class="faq-text">The duration varies depending on the type of scan. After the tracer injection,
                        a waiting period of 30 minutes to a few hours may be needed for the tracer to reach the target
                        organ. The actual imaging typically takes 30 to 60 minutes with faster results delivered through
                        Scans World's advanced system.</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="accordion-card">
                  <div class="accordion-header" id="headingTen">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      10. How do I book a Gamma Camera / Nuclear Scan appointment at Scans World Chennai?
                    </button>
                  </div>
