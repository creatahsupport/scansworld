...
<section class="space text-center">
    <div class="container">
        <div class="thankyou-box">
            <img src="assets/scan-world/green-tick-green.webp" alt="Thank You" class="mb-4" style="max-width:150px;">
            <h2 class="text-theme">Thank You!</h2>
            <p class="mt-3 mb-4">
                Your submission has been received successfully. <br>
                Our team will get back to you shortly.
            </p>
            <a href="./" class="th-btn style2">Back to Home</a>
        </div>
    </div>
</section>
